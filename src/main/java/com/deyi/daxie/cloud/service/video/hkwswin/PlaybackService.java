...
//        String sFileName = "C:\\Users\\cxb\\Desktop\\sdk\\video\\3541241.mp4" ;
...
//        }
    ...
    public void jButtonRealPlayActionPerformed(ConGasStationMonitoring drvice, String strFileName) {
        ...
        lpPreviewInfo = new HCNetSDK.NET_DVR_PREVIEWINFO();
        lpPreviewInfo.lChannel = new NativeLong(drvice.getDeviceChannel());
        /*lPreviewHandle = hCNetSDK.NET_DVR_RealPlay_V30(m_lUserID,
                m_strClientInfo, fRealDataCallBack, null, true);*/
        lPreviewHandle = hCNetSDK.NET_DVR_RealPlay_V40(m_lUserID, lpPreviewInfo,fRealDataCallBack, null);
